      ...
      <div class="row">
        ...
        <div class="col-6">
          <table
            ...
            class="table table-info table-bordered mx-auto mb-5"
           >
            <thead>
            ...
            <tbody>
              <tr>
                <td colspan="3" class="table-primary">
                  <span class="d-block text-center" v-if="item.length > 0 && item[0].day_in == 'ПН '" >Понедельник</span>
                  <span class="d-block text-center" v-if="item.length > 0 && item[0].day_in == 'ВТ '" >Вторник</span>
                  <span class="d-block text-center" v-if="item.length > 0 && item[0].day_in == 'СР '" >Среда</span>
                  <span class="d-block text-center" v-if="item.length > 0 && item[0].day_in == 'ЧТ '" >Четверг</span>
                  <span class="d-block text-center" v-if="item.length > 0 && item[0].day_in == 'ПТ '" >Пятница</span>
                  <span class="d-block text-center" v-if="item.length > 0 && item[0].day_in == 'СБ '" >Суббота</span>
                  <span class="d-block text-center" v-if="item.length > 0 && item[0].day_in == 'ВС '" >Восскресенье</span>
                </td>
              </tr>
              <tr
                v-for="x in item"
              ...
              >
                <td 
                  ...
                  v-bind:key="i"
                  v-bind:style="i.id == x.lesson_id ? '' : 'display: none;'"
                >
