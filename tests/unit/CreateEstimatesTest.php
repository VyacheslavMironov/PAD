...
class CreateEstimatesTest extends \Codeception\Test\Unit
{
    ...
    protected function _before()
    {
        ...
        $statementsCreateTest = new StatementsCreateRepository();
        $response_create_statements = $statementsCreateTest->create(new StatementsCreateDTO(
            $response_create_student_user['id'],
            $response_lesson_create['id'],
            $response_create_teacher_user['id'],
            'Ежедневная',
        ...
        // Проверка параметров возвращаемого массива
        $this->assertNotNull($response_create_statements);
        $this->assertArrayHasKey('id', $response_create_statements);
        $this->assertArrayHasKey('value', $response_create_statements);
        $this->assertArrayHasKey('day', $response_create_statements);
        $this->assertArrayHasKey('month', $response_create_statements);
        $this->assertArrayHasKey('year', $response_create_statements);
        $this->assertArrayHasKey('lesson_id', $response_create_statements);
        $this->assertArrayHasKey('user_from', $response_create_statements);
    }
