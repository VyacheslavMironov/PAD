...
class CreateLessonTest extends \Codeception\Test\Unit
{
    ...
    protected function _before()
    {
        ...
        $response = $lessonCreateTest->create(new LessonCreateDTO(
        ...
        $this->assertEquals('Математика', $response['name']);
        $this->assertArrayHasKey('name', $response);
        $this->assertNotNull($response['id']);
        $this->assertNotNull($response['organization_id']);
