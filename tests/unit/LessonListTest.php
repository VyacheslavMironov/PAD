...
class LessonListTest extends \Codeception\Test\Unit
{
    ...
    protected function _before()
    {
        ...
        foreach (['Физика', 'ИЗО', 'История', 'Русский язык', 'Литература', 'Математика'] as $value) {
        ...
        $lessonList = new LessonListRepository();
        $response = $lessonList->lessonByOrganizationId(new LessonListDTO(
            $response_create_organization[3]['organization_id'],
            null,   // filial_id
            null,   // teacher_id
        ));
