...
class RemoveUserGroupTest extends \Codeception\Test\Unit
{
    ...
    protected function _before()
    {
        ...
        foreach ($arr as $value) {
            ...
            $userShowGroupTest = new UserGroupRemoveRepository();
            $response_show_group_user = $userShowGroupTest->remove(new UserGroupRemoveDTO(
                $response_create_organization[3]['organization_id'],
                $response_filial_create['id'],
                $response_create_student_user['id'],
                $response_create_group['id']
